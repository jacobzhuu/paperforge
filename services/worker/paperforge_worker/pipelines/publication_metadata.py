...
_EN_STOPWORDS = {
    "about", "after", "also", "among", "based", "been", "being", "between", "both",
    "from", "have", "into", "more", "most", "paper", "results", "review", "shows",
    "study", "that", "their", "these", "this", "through", "using", "were", "which",
    "with", "within",
}
