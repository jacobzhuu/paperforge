%% 与 latex_render/templates/ieeetran.tex.j2 的导言区保持一致。
...
\begin{document}
\title{中文预热}\author{\IEEEauthorblockN{Ada Lovelace}}
\maketitle
\begin{abstract}warmup\end{abstract}
\begin{IEEEkeywords}warmup\end{IEEEkeywords}
\section{中文章节}
中文正文与引用~\cite{warmup2020sample} and \todo{placeholder}.
