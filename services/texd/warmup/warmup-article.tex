...
%% natbib：article 模板用它把 plainnat 的作者-年份标签排成 (Wang et al., 2023)。
%% 宏包按文件缓存，选项不影响缓存；这里与模板逐条对齐是
%% test_warmup_covers_templates 的判据。
...
Text with a citation~\citep{warmup2020sample} and \citet{warmup2020sample} and \todo{placeholder}.
